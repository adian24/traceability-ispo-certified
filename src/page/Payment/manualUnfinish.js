...
const ManualUnfinish = () => {
  ...
  const toHistory = async () => {
    if(order_id) {
      ...
      window.ReactNativeWebView.postMessage("Unfinish");
    }
  };
            ...
            <div className="" style={{background:'white'}}>
              <Card className="" >
                <Card.Body className="text-center">
                  ...
                  <p className="text-contain" style={{ color:'orange', fontWeight:'bold' }}>
                    Sorry, Your transacation is Unfinish. Please check history transaction!
                  </p>
                  <p className="text-contain">
                    Status :{" "}
                    {transaction_status ? (
                      <span className="text-status" style={{ color:'orange', fontWeight:'bold' }}>{transaction_status}</span>
                    ) : (
