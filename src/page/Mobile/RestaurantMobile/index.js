...
const RestaurantMobile = () => {

  const { data }    = useSelector((s) => s.GetPlace)
  ...
  useEffect(() => {
    if (window.innerWidth > 767) return history.replace("/restaurant")
  }, [])
    ...
    <>
      <div className={listMenu? "hide-map" : "map"}>
        ...
        <div className="map-mobile">
          <MapRestaurant map_id={data.map_id} nearby={nearby} />
        </div>
      </div>
      <div 
