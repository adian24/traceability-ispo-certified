...
const Company = (props) => {
  ...
  const { data }                                          = useSelector((s) => s.GetCompany);
  ...
  //   )
  // })
  // console.log("verifyyyyyyyyyyyyy", auth.currentUser)
  ...
  // const [usia_tanaman, setUsiaTanaman] = useState(null);
  // const [file, setFile] = useState("");
  
  // const [checkedFacility, setCheckedFacility] = useState(false);
  
  // console.log(prov, "ini provinsi");
  // console.log(city, "ini city");
  // console.log(dist, "ini kecamataaaaaaaaaaaaaan");

  

  // const options_select_sert = [];
  // master_sertifikat && master_sertifikat.map((value, i) => { 
  ...
  // })
  // form.append("facility", valcheckedFacility);

  // console.log('photo', selectedImage)
  
  // console.log(checked, "isi checked");
  // console.log(valchecked, "isi val checked");
  ...
  useEffect(() => {
    Axios.get(`${URIChart}/map?cmid=4&limit=10000`)
      .then((res) => {
  ...
  // console.log('GET companyList', companyList)
  // console.log('GET hasMoreItems', hasMoreItems)
  // console.log('LOAD LIST COMPANY', loadCompanyList())
  
  return (
    <>
      <CategoryBar activeCategory="company" />
      <div className="main-page-category-company">
        ...
        <div className="left-category-company">
              ...
              <div className="row">
                <div className="col-md-6">
                  <div className="pt-4" style={{ width:'100%', height:'200px' }}>
                    ...
                    <MapPicker
                      center={[
                        latitudeMap ? parseFloat(latitudeMap) : (location.lat ? parseFloat(location.lat) : 1.0),
                        longitudeMap ? parseFloat(longitudeMap) : (location.lng ? parseFloat(location.lng) : 100.0)
                      ]}
                          ...
                          <div className="row">
                            <div className="col-md-6">
                              ...
                              >
                                ...
                                {master_sertifikat && master_sertifikat.map((value, i) => {
                                  return <option key={i} value={value.iso_id}>{value.iso_name}</option>
                                })}
                              </select>
                            </div>
                            <div className="col-md-6 ">
                          ...
                          <div className="row">
                            <div className="col-md-12">
                              ...
                              >
                                ...
                                {master_ls && master_ls.map((value, i) => {
                                  return <option key={i} value={value.id_ls}>{value.nama_ls}</option>
                                })}
                              </select>
                            </div> 
                          </div>
          ...
          <div style={{ zIndex: 2 }}>
            ...
            <div className="row mx-2">
                <div className="col-md-6 mt-2">
                  ...
                  {/* <div className="box-nearby" style={{ color:'white', display:'flex' }}>
                  ...
                  {/* <span className="" style={{ color:'white', display:'flex' }}>
                    Nearby Locations
                  ...
                  /> */}
                  {/* <span className="mt-2 nearby pl-3">Nearby Location</span> */}
                </div>
                <div className="col-md-6">
                  <select
            ...
            {/* <div className="ml-3 d-flex">
              <input
                ...
                style={{ transform: 'scale(2)' }}
              />
              <p className="mt-3 nearby pl-2">Nearby Location</p>
            </div>
            <div
              style={{
                display: "flex",
          ...
          {/* <Scrollbars style={{ height: "80vh", marginTop: '4ex' }} > */}
              ...
              {nearby
                ...
                : 
                  ...
                  :
                    <div>
                      <div style={{ height:'80vh', overflow:'auto', marginTop:'2ex'}}>
                        <InfiniteScroll
                          // threshold={0}
                          pageStart={0}
        ...
        <div className="right-category-company">
          <div className="maps-category-company">
            <MapCompany map_id={data.map_id} nearby={nearby} search={search} data={getIsoId || search ? data : allMapData} />
          </div>
        </div>
      </div>
    </>
